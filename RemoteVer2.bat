...
rem echo              J###                         ###L                      
rem echo              {###K                       J###K                      
rem echo              ]####K      ___aaa___      J####F                      
rem echo          __gmM######_  w#P""   ""9#m  _d#####Mmw__                  
rem echo       _g######BLYAT###mZ_         __g######SUKKA###m_               
rem echo     _d####M@PPPP@@M#######Mmp gm#########@@PPP9@M####m_             
rem echo    a###""          ,Z"#####@" '######"\g          ""M##m            
rem echo   J#@"             0L  "*##     ##@"  J#              *#K           
rem echo   #"               `#    "_iTayDa_~    dF               `#_          
rem echo  7F                 "#_   ]#####F   _dK                 JE          
rem echo  ]                    *m__ ##### __g@"                   F          
rem echo  w                      "PJ#####LP"                      w           
rem echo   `                       0######_                      '           
rem echo     e                    _0########_                  3                 
rem echo       .               _d#####^#####m__              ,              
rem echo        "*w_________am#####P"   ~9#####mw_________w*"                  
rem echo            ""9@#####@M""           ""P@#####@M""                    
rem echo.
rem echo.
echo.
...
rem start ping 10.1%s1%.%s2%.%new% -t
echo Pida Ras
set /p _stop1=Kill?:

If "%_stop1%"=="3" goto :Bhira
if "%_snif%"=="" goto :start
...
rem start ping 10.1%s1%.%s3%.%new% -t
